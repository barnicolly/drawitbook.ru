...
const loaders = {
    ...
    FileLoader: (isProduction, options) => new FileLoader(isProduction, options).get(),
    SvgSpriteLoader: (isProduction, options) => new SvgSpriteLoader(isProduction, options).get(),
...
const CopyPlugin = require('../plugins/CopyWebpackPlugin');
...
const plugins = {
    ...
    WriteFilePlugin: (options) => WriteFilePlugin(options),
    CopyPlugin: (options) => CopyPlugin(options),
    ProvidePlugin: (options) => ProvidePlugin(options),
