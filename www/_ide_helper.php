 ...
 */
     ...
     */ 
         ...
         *
         * @internal 
         * @return \App\Ship\Kernels\ConsoleKernel 
         * @static 
         */ 
     ...
     */ 
         ...
         *
         * @param mixed $id
         * @return \App\Containers\User\Models\User|false 
         * @static 
         */ 
...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getRouteHome($parameters = [], $absolute = true, $lang = null)
        {
                        /** @var \App\Ship\Services\Route\RouteService $instance */
                        return $instance->getRouteHome($parameters, $absolute, $lang);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getRouteSearch($parameters = [], $absolute = true, $lang = null)
        {
                        /** @var \App\Ship\Services\Route\RouteService $instance */
                        return $instance->getRouteSearch($parameters, $absolute, $lang);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getRouteArt($id, $absolute = true, $lang = null)
        {
                        /** @var \App\Ship\Services\Route\RouteService $instance */
                        return $instance->getRouteArt($id, $absolute, $lang);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getRouteArtsCell($parameters = [], $absolute = true, $lang = null)
        {
                        /** @var \App\Ship\Services\Route\RouteService $instance */
                        return $instance->getRouteArtsCell($parameters, $absolute, $lang);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getRouteArtsCellTagged($tag, $absolute = true, $lang = null)
        {
                        /** @var \App\Ship\Services\Route\RouteService $instance */
                        return $instance->getRouteArtsCellTagged($tag, $absolute, $lang);
        }
                    /**
         * 
         *
